...
const BY_CHAPTER = {
  1: [
    ...
    { q: "Interprofessional teams exist because modern care requires:", opts: ["One professional to perform every task alone", "Coordinated roles across clinical and operational disciplines", "Elimination of pharmacists", "Patients to code their own charts"], c: 1, exp: "Teams combine licensure, skills, and operational support." },
    { q: "Health care–associated infections (HAIs) are tracked because they:", opts: ["Increase length of stay, cost, and harm", "Only affect outpatient clinics", "Are always billed as cosmetic procedures", "Require no prevention standards"], c: 0, exp: "HAIs are preventable harm with system-level impact." },
    { q: "ACA marketplace plans primarily serve:", opts: ["Only veterans", "Self-employed and uninsured populations seeking standardized benefits", "Inpatient-only surgical cases", "International tourists exclusively"], c: 1, exp: "Marketplaces expanded individual coverage options." },
    { q: "A learner confuses urgent care with emergency department. Urgent care is best for:", opts: ["Stroke symptoms and major trauma", "Low-acuity evening/weekend needs when PCP unavailable", "Open-heart surgery", "Long-term nursing home placement"], c: 1, exp: "Urgent care bridges gaps; ED handles high acuity." },
    { q: "Value-based payment programs increasingly tie dollars to:", opts: ["Volume of procedures regardless of outcome", "Outcomes, safety, and cost—not volume alone", "Social media followers", "Parking revenue"], c: 1, exp: "Value-based models reward quality and efficiency." },
  ],
  2: [
