...
export const INSURANCE_QUIZ_BANK: QuizQuestion[] = [
  q(
    "q01",
  ...
  q(
    "q106",
    "A needs analysis before buying insurance should prioritize:",
    [
      "Choosing the lowest premium regardless of limits",
      "Identifying what assets, income, and obligations must be protected",
      "Buying only one policy type for life",
      "Avoiding all liability coverage",
    ],
    1,
    "Needs analysis matches coverage to real financial exposure — not just price."
  ),
  q(
    "q107",
    "When comparing insurance quotes fairly, you should:",
    [
      "Compare only the monthly payment",
      "Match limits, deductibles, exclusions, and carrier strength across options",
      "Assume all policies include flood and earthquake",
      "Ignore the declarations page",
    ],
    1,
    "Apples-to-apples comparison requires the same coverage structure, not just premium."
  ),
  q(
    "q108",
    "Underinsuring a home for premium savings can trigger:",
    [
      "Automatic doubling of all limits",
      "Co-insurance penalties that reduce claim payments",
      "Guaranteed replacement cost with no deductible",
      "Federal takeover of the policy",
    ],
    1,
    "Co-insurance clauses penalize carrying less than a required percentage of replacement value."
  ),
  q(
    "q109",
    "An independent insurance agent typically:",
    [
      "May place business with multiple carriers to fit client needs",
      "Is prohibited from selling any commercial coverage",
      "Works only for one state guaranty association",
      "Issues federal Medicare cards directly",
    ],
    0,
    "Independent agents and brokers shop the market; captive agents represent one carrier."
  ),
  q(
    "q110",
    "Agency management systems (AMS) primarily help agencies:",
    [
      "Track policies, documents, tasks, and client communication",
      "Replace all state insurance laws",
      "Eliminate the need for producer licensing",
      "Guarantee zero claims denials",
    ],
    0,
    "AMS platforms operationalize renewals, endorsements, and service workflows."
  ),
];

export { INSURANCE_QUIZ_BANK as FACTS_QUIZ_BANK };
