...
export const TEXTBOOK_INTRO = {
  ...
  subtitle: "ForgEd deep-dive — history, law, products, claims, and career-ready literacy",
  paragraphs: [
...
export const INSURANCE_TEXTBOOK: TextbookChapter[] = [
  ...
  },
  {
    id: "buying-guide",
    number: 12,
    title: "Buying insurance wisely",
    subtitle: "Coverage decisions, comparisons, and common mistakes",
    sections: [
      {
        id: "needs-analysis",
        title: "12.1 Start with a needs analysis",
        paragraphs: [
          "Before comparing quotes, clarify what you are protecting: income, home equity, vehicles, business operations, or health expenses. List assets, debts, dependents, and contractual requirements from lenders or landlords.",
          "A needs analysis prevents buying the wrong product — such as permanent life when term would cover the mortgage, or minimum auto limits when assets would be exposed in a lawsuit.",
        ],
        bulletPoints: [
          "Inventory what you own and what you owe",
          "List people who depend on your income",
          "Note legal minimums vs. recommended limits",
          "Separate must-have coverage from nice-to-have riders",
        ],
      },
      {
        id: "comparing-quotes",
        title: "12.2 Comparing quotes fairly",
        paragraphs: [
          "Price is only one variable. Compare limits, deductibles, exclusions, carrier financial strength ratings, claims reputation, and agent service. Two policies with the same premium can offer very different protection.",
          "Ask for declarations pages or summary documents in writing. Verify that drivers, addresses, and construction details are accurate — errors can void coverage at claim time.",
        ],
        bulletPoints: [
          "Match limits and deductibles across quotes",
          "Check A.M. Best or similar financial strength ratings",
          "Read exclusions for flood, mold, and wear-and-tear",
          "Confirm discounts (bundling, telematics, security systems)",
        ],
      },
      {
        id: "common-mistakes",
        title: "12.3 Mistakes that cost policyholders",
        paragraphs: [
          "Underinsuring a home to save premium leads to co-insurance penalties. Lapse in auto coverage can trigger higher rates and SR-22 requirements. Failing to update beneficiaries after life events leaves proceeds to unintended recipients.",
          "Assuming flood or earthquake is included on homeowners policies is a frequent and expensive error. Assuming short-term health plans equal ACA major medical leaves dangerous gaps.",
        ],
      },
    ],
  },
  {
    ...
    number: 13,
    title: "Agency operations and career paths",
    subtitle: "How distribution works and where learners can grow",
    sections: [
      {
        id: "distribution",
        title: "13.1 Agents, brokers, and carriers",
        paragraphs: [
          "Carriers issue policies and pay claims. Captive agents represent one carrier; independent agents and brokers may place business with multiple carriers. Managing general agents (MGAs) support specialized programs.",
          "Producers must be licensed, appointed, and compliant with continuing education. Compensation may be commission, fee, or salary depending on the agency model.",
        ],
        bulletPoints: [
          "Carrier — underwrites risk and pays claims",
          "Agent — sells on behalf of carrier(s)",
          "Broker — represents the buyer in many placements",
          "MGA — wholesale programs for niche risks",
        ],
      },
      {
        id: "client-service",
        title: "13.2 Client service workflow",
        paragraphs: [
          "Typical agency workflow: prospecting, needs analysis, quote, bind, certificate delivery, endorsements, renewals, and claims advocacy. Agency management systems (AMS) track policies, documents, and tasks.",
          "Strong agencies document advice, use checklists at renewal, and proactively review coverage when life events occur — marriage, new drivers, home renovation, or business expansion.",
        ],
      },
      {
        id: "career-paths",
        title: "13.3 Career paths in insurance",
        paragraphs: [
          "Entry paths include customer service representative, licensed producer, claims adjuster trainee, underwriting assistant, and marketing specialist. Advancement may lead to agency owner, commercial lines broker, or corporate leadership.",
          "Industry credentials (CPCU, CLU, ChFC, AU, ARM) signal expertise. Technology skills — data literacy, CRM, and ethical AI use — are increasingly valuable alongside traditional product knowledge.",
        ],
        citations: [
          {
            source: "NAIC — Becoming an insurance agent",
            url: "https://content.naic.org/industry/becoming-an-insurance-agent",
          },
          {
            source: "Bureau of Labor Statistics — Insurance sales agents",
...
export const TEXTBOOK_CHAPTER_COUNT = INSURANCE_TEXTBOOK.length;
