...
export const HLTH_CH11 = chapter(
  ...
  [
    section(
      ...
      "11.1 Why mental health belongs in every care setting",
      [
    ...
    section(
      ...
      "11.2 Common conditions learners actually encounter",
      [
    ...
    section(
      ...
      "11.3 Screening tools and what a positive screen means",
      [
    ...
    section(
      ...
      "11.4 Integrated care, peer support, and the 988 crisis line",
      [
    ...
    section(
      ...
      "11.5 Workplace boundaries, burnout, and supporting colleagues",
      [
