...
export const HLTH_CH13 = chapter(
  ...
  [
    section(
      "diagnostics-labs-s1",
      "13.1 How clinicians think about tests: rule in, rule out, monitor",
      [
    ...
    section(
      "diagnostics-labs-s2",
      "13.2 Laboratory basics: specimens, reference ranges, and critical values",
      [
    ...
    section(
      "diagnostics-labs-s3",
      "13.3 Common panels learners should decode for patients",
      [
    ...
    section(
      "diagnostics-labs-s4",
      "13.4 Imaging literacy: X-ray, ultrasound, CT, MRI",
      [
    ...
    section(
      "diagnostics-labs-s5",
      "13.5 Explaining results, prior authorization, and patient-facing logistics",
      [
