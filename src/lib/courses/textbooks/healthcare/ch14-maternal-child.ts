...
export const HLTH_CH14 = chapter(
  ...
  [
    section(
      "maternal-child-s1",
      "14.1 Pregnancy as a continuum—not just delivery day",
      [
    ...
    section(
      "maternal-child-s2",
      "14.2 Newborn care, screening, and safe sleep",
      [
    ...
    section(
      "maternal-child-s3",
      "14.3 Early childhood development and preventive visits",
      [
    ...
    section(
      "maternal-child-s4",
      "14.4 Adolescent health: confidentiality, consent, and risk behavior",
      [
    ...
    section(
      "maternal-child-s5",
      "14.5 NICU, pediatrics subspecialty, and family-centered care",
      [
