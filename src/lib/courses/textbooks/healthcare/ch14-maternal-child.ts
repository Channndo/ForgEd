...
export const HLTH_CH11 = chapter(
  ...
  [
    section(
      "maternal-child-s1",
      "11.1 Pregnancy as a continuum—not just delivery day",
      [
    ...
    section(
      "maternal-child-s2",
      "11.2 Newborn care, screening, and safe sleep",
      [
    ...
    section(
      "maternal-child-s3",
      "11.3 Early childhood development and preventive visits",
      [
    ...
    section(
      "maternal-child-s4",
      "11.4 Adolescent health: confidentiality, consent, and risk behavior",
      [
    ...
    section(
      "maternal-child-s5",
      "11.5 NICU, pediatrics subspecialty, and family-centered care",
      [
