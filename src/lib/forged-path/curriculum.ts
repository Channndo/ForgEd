...
export const FORGED_PATH_PHASES: ForgedPathPhase[] = [
  {
    ...
    courses: [
      ...
      },
      {
        ...
        title: "Any Stanford Online Course (your choice)",
        link: "https://online.stanford.edu/explore?type=course&filter%5B0%5D=free",
        purposes: [
          "Enrollment exception — pick any Stanford Online course",
          "Free courses count",
          "Economics or strategy recommended",
        ],
    ...
    courses: [
      {
        ...
        purposes: [
          "Enrollment exception — pick any Stanford Online course",
          "Free courses count",
          "Strategy or leadership recommended",
        ],
        platform: "stanford-online",
      },
      {
  ...
  },
  {
    ...
    courses: [
      ...
      },
      {
        ...
        title: "Any Princeton Online Course (your choice)",
        link: "https://online.princeton.edu/",
        purposes: [
          "Enrollment exception — pick any Princeton Online course",
          "Free courses count",
          "Governance or policy recommended",
        ],
